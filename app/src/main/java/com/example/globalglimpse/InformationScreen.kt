...
@Composable
fun InformationScreen(modifier: Modifier , onBackClicked: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "New Wonders" , fontWeight = FontWeight.Bold ) },
                navigationIcon = {
...
fun LandmarkPhoto(image: Painter) {
    Image(
        ...
        modifier = Modifier.size(height = 320.dp , width = 400.dp)
            .padding(top = 60.dp),
